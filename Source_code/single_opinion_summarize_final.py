...
def sentiment_analysis():
    ...
    if len(tot_text) > 1:
        ...
        if pred_tot_sentiment == ['post']:
            if len(str_summarize_final) == 0:
                str_summarize_final = "Overal is positive."
            else:
                str_summarize_final = str_summarize_final + " Overal is positive."
        elif pred_tot_sentiment == ['neg']:
            if len(str_summarize_final) == 0:
                str_summarize_final = "Overal is negative."
            else:
                str_summarize_final = str_summarize_final + " Overal is negative."
        elif pred_tot_sentiment == ['neu']:
            if len(str_summarize_final) == 0:
                str_summarize_final = "Overal is neutral."
            else:
                str_summarize_final = str_summarize_final + " Overal is neutral."
    # performance
