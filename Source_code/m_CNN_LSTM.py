...
model_json_full = "CNN_LSTM_aspect.json"
...
model.add(MaxPooling1D(pool_size=3))
model.add(Dropout(0.3))
model.add(Conv1D(299, kernel_size=5, padding='same', activation='sigmoid'))
model.add(MaxPooling1D(pool_size=3))
model.add(Dropout(0.4))
model.add(LSTM(300))
...
checkpoint_filepath = 'CNN_LSTM_aspect-{epoch:03d}-{val_loss:.4f}-{val_accuracy:.4f}.h5'
